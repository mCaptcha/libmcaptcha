...
pub enum CaptchaError {
    ...
    #[display("LevelBuilder should have atleaset one level configured")]
    LevelEmpty,
    ...
    #[display("difficulty factor must be greater than zero")]
